package com.meta.framework.common.utils.poi;
...
public class ExcelUtil<T>
{
     ...
     * @return 结果
     */
    public CommonRes exportExcel(List<T> list, String sheetName)
    {
     ...
     * @return 结果
     */
    public CommonRes importTemplateExcel(String sheetName)
    {
    ...
    public CommonRes exportExcel()
    {
        ...
        try
        {
            ...
            wb.write(out);
            return CommonRes.successMsg(filename);
        }
        catch (Exception e)
        {
    ...
    {
        String downloadPath = MetaConfig.getDownloadPath() + filename;
