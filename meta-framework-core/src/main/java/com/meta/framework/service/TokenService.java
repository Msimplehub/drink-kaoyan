...
public class TokenService
{
    ...
    {
        // 获取请求携带的令牌
        return getLoginUser(getToken(request));
}
    ...
    public String createToken(LoginUser loginUser)
    {
        ...
        String lastToken = Optional.ofNullable(getLastTokenByUserId(userId)).orElse("");
        ...
        // 新增：删除上一个登录token信息
        delLoginUser(lastToken);
        // 新增：设置一个新的tokenKey
        setNewTokenByUserId(userId, token);
     ...
     * @return void
     */
    private void setNewTokenByUserId(Long userId, String token) {
    ...
    {
        return Constants.LOGIN_USER_TOKEN_KEY + userId;
    }
}
