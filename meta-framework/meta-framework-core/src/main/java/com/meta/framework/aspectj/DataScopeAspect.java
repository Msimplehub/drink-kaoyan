...
import com.meta.framework.common.annotation.DataScope;
import com.meta.framework.act.entity.SysRole;
...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.meta.framework.common.annotation.DataScope)")
